...
class HeaderFilter {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (popupElement) {
                this._eventManager.addEventListener(document, "click", (_e) => {
                    if ($popup) {
                        const popupElement = $popup.get(0);
                        if (!(popupElement === null || popupElement === void 0 ? void 0 : popupElement.contains(_e.target))) {
                            closePopup($popup);
                            this.activePopup = null;
                        }
                    }
    ...
    createList(checkboxContainer) {
        const containerEl = checkboxContainer.get(0);
        if (!containerEl) {
            throw new Error("Checkbox container element not found");
        }
        return new virtualizedList_1.VirtualizedList(containerEl, this._listData, (itemContainer, item) => {
    ...
    applyFilterSelections() {
        ...
        this.onFilterApplied.notify({ grid: this.grid, column: this.columnDef });
    ...
    handleMenuItemClick(command, columnDef) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.onCommand.notify({ grid: this.grid, column: columnDef, command: command });
            this.setFocusToColumn(columnDef);
        });
    }
    createFilterList() {
