...
class QueryResultWebviewPanelController extends reactWebviewPanelController_1.ReactWebviewPanelController {
    ...
    registerRpcHandlers() {
        ...
        this.registerRequestHandler("viewReady", () => __awaiter(this, void 0, void 0, function* () {
            // This is a no-op. The webview is ready when the view is created.
            // However, this and the companion `queryResultWebviewController` both communicate with
            // the same react app, which will call this handler when the webview is ready. Registering
            // to avoid errors in the console for missing handlers.
        }));
