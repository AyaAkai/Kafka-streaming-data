...
class ConnectionUI {
    ...
    handleSelectedConnection(selection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const resolvedConnectionCreds = yield this.fillOrPromptForMissingInfo(selection);
                return resolvedConnectionCreds;
            }
            catch (err) {
                throw err; // we will send back a cancelled error in order to re-prompt the promptForConnection
            }
        });
    }
     ...
     * false otherwise
     */
    handleFirewallError(_uri, profile, ipAddress) {
        return __awaiter(this, void 0, void 0, function* () {
