...
class TableDesignerWebviewController extends reactWebviewPanelController_1.ReactWebviewPanelController {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Note: getConnectionString is currently not implemented in PGTS
    ...
    registerRpcHandlers() {
        ...
        this.registerReducer("publishChanges", (state, payload) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (targetNode && this._objectExplorerTree) {
                try {
                    // Check if the Object Explorer tree is visible
                    if (this._objectExplorerTree.visible) {
                    ...
                    console.error(`Failed to reveal node in Object Explorer: ${(0, utils_1.getErrorMessage)(err)}. Node: ${targetNode.id || targetNode.label}`);
                }
