...
class UserSurvey {
    ...
    promptUserForNPSFeedback() {
        void (() => __awaiter(this, void 0, void 0, function* () { return this.promptUserForNPSFeedbackAsync; }))();
    }
        ...
        this.registerReducer("submit", (state, payload) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (payload.answers.nps < 7 /* NPS detractor */ ||
                ...
                if (response === locConstants.UserSurvey.submitIssue) {
                    ...
                    const issueUrl = `${constants.repoUrl}/issues/new?labels=User-filed,Triage:%20Needed&body=${encodedIssueBody}`;
...
|Software|Version|
|--|--|
|PGSQL Extension|${extensionVersion}|
