...
class ConnectionDialogWebviewState {
    ...
    constructor(params) {
        ...
        this.editingExistingConnection = false;
        ...
        this.testConnectionStatus = webview_1.ApiStatus.NotStarted;
        ...
        this.fetchingAzureDatabasesStatus = webview_1.ApiStatus.NotStarted;
        this.serverToDatabaseMap = {};
