...
class ScriptingService {
    ...
    /**
     * The tools service expects a metadata object and not a script object
     * for the request parameters.
     */
    getObjectMetadataFromScriptingObject(scriptingObject) {
        return {
            metadataTypeName: scriptingObject.type,
            schema: scriptingObject.schema,
            name: scriptingObject.name,
            urn: undefined,
    ...
    createScriptingParams(node, uri, operation) {
        ...
        let scriptingParams = {
            ...
            scriptingObjects: [this.getObjectMetadataFromScriptingObject(scriptingObject)],
