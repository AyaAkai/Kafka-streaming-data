...
class QueryRunner {
    ...
    doRunQuery(selection, queryCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let onSuccess = (result) => {
                ...
                vscode.commands.executeCommand("setContext", "pgsql.runningQueries", QueryRunner._runningQueries);
                ...
                (0, telemetry_1.sendActionEvent)(telemetry_2.TelemetryViews.QueryEditor, telemetry_2.TelemetryActions.RunQuery, {
                    isSelection: ((_a = (!!selection)) === null || _a === void 0 ? void 0 : _a.toString()) || "false",
                });
            };
            let onError = (error) => {
                ...
                (0, telemetry_1.sendErrorEvent)(telemetry_2.TelemetryViews.QueryEditor, telemetry_2.TelemetryActions.RunQuery, error, false);
            };
    ...
    handleResultSetComplete(result) {
        ...
        // Queries that produce no resultSets (typically errors) will have no summary
        if (!resultSet) {
            return;
        }
