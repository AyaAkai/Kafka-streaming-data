...
exports.parseDockerLikeImageName = void 0;
/**
 ...
 */
function parseDockerLikeImageName(originalName) {
    if (!originalName) {
        return {
            originalName,
        };
...
exports.parseDockerLikeImageName = parseDockerLikeImageName;
//# sourceMappingURL=parseDockerLikeImageName.js.map